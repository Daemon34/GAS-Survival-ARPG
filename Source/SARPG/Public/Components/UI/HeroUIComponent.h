...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnAbilityCooldownBeginDelegate, FGameplayTag, AbilityInputTag, float, TotalCooldownDuration, float, CooldownTimeRemaining);
 ...
 */
UCLASS()
class SARPG_API UHeroUIComponent : public UPawnUIComponent
{
	GENERATED_BODY()
