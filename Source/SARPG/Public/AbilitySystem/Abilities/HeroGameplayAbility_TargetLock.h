 ...
 */
UCLASS()
class SARPG_API UHeroGameplayAbility_TargetLock : public USARPGHeroGameplayAbility
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Target Lock")
	TSubclassOf<USARPGWidgetBase> TargetLockWidgetClass;
	...
	UPROPERTY()
	USARPGWidgetBase* DrawnTargetLockWidget;
